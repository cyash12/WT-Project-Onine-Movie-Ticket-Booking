...
$fseat=$_POST["fseat"];
$tseat=$_POST["tseat"];
$uid=$_SESSION['email'].$_SESSION['stime'];
$bid=mt_rand(10,100000);
$fname=$_POST['bfname'];
$lname=$_POST['blname'];
$email=$_POST['bemail'];
...
$qry="INSERT INTO boooking_det(booking_id,fname,lname,email,mobile,tname,mname,stime,date,row,start_seat,total_seat) VALUES('$bid','$fname','$lname','$email','$mno','$tname','$mname','$stime','$date','$row','$fseat','$tseat');";
mysqli_query($connection,$qry);}
else{ echo 'please log in or sign up to book tickets';}
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<div style="background-color: #393939; position: absolute;left:0px; top: 1282px; width: 100%; height: 100px; padding: 15px;">
