...
$unm=$_POST['email'];
$upass=$_POST['passwd'];
$qry="SELECT * FROM user_det WHERE user_email='$unm'";
$res=mysqli_query($connection,$qry);
$row=mysqli_fetch_assoc($res);
$pwd=$row['user_pass'];
if($pwd==$upass){ $_SESSION["fname"]=$row['user_fname'];
$_SESSION["lname"]=$row['user_lname'];
$_SESSION["email"]=$row['user_email'];$_SESSION['logged']='1'; }
else { $_SESSION['logged']='0'; echo '<script type="text/javascript">alert("wrong password");</script>';}

?>
<body>
<?php  if($_SESSION['logged']=='1')
echo '<div style="position:absolute; left:90%; top:0.01%;">
...
<div class="header" style=" background-image: url(black.jpg); position: absolute; top: 0px; width: 100%; height: 10%; left: 0px; padding-left: 0px; margin-left: 0px; z-index:2;">
	<div style=" position: absolute; top: 8px; left: 10px;">
		<a href="onlogin.php"> <img src="home.png" height="50px" width="60px" class="image"> </a>
	</div>
	...
	<?php if($_SESSION['logged']=='0'){echo' <div class="signin">
		<a href="index.php"><button id="sign_in"> SIGN IN </button></a>		
	</div>'	;}?>
	<?php if($_SESSION['logged']=='1'){echo' <div class="signin" style="position:absolute;left:95%;">
		<a href="index.php"><button style="z-index:20;" id="sign_in"> Log Out </button></a>		
	</div>'	;}?>
    <?php if($_SESSION['logged']=='1'){echo' <div class="signin">
		<a href="bookingdetails.php"><button style="z-index:20;" id="sign_in"> My Bookings </button></a>		
	</div>'	;}?>
