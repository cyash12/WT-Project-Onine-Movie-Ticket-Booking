...
<div class="header" style=" background-image: url(black.jpg); position: absolute; top: 0px; width: 100%; height: 10%; left: 0px; padding-left: 0px; margin-left: 0px; z-index:2;">
	...
	<div class="signin">
		<a href="index.php"><button id="sign_in"> SIGN IN </button></a>		
	</div>	
...
<div id="boxes">
  ...
  <h3>SELECT YOUR CITY</h3>
	...
	<form action="" method="get">
     <input list="city" style="color:black;">
		<datalist id="city" align="center">
			<option value="Ahemdabad">
			<option value="Chennai">
			<option value="Chandigarg">
			<option value="Delhi">
			<option value="Dheradun">
    ...
    <div id="popupfoot"> <a href="#" class="close agree"> SUBMIT </a> </div>
  </div>
  <div style="width: 1478px; font-size: 32pt; color:black; height: 602px; display: none; opacity: 0.8;" id="mask"></div>
</div>
<script src="http://ajax.googleapis.com/ajax/libs/jquery/1.11.1/jquery.js"></script> 
<script src="Simple-jQuery-Plugin-For-Opening-A-Popup-Window-On-Page-load\main.js"></script>
  ...
  <!-- #region Jssor Slider Begin -->
    ...
    <div id="jssor_1" style="position: absolute; top: 60px; left: 0px; width: 1300px; height: 500px; overflow: hidden; visibility: hidden;">
        ...
        <div data-u="navigator" class="jssorb05" style="bottom:16px;right:16px;" data-autocenter="1">
            ...
            <div data-u="prototype" style="width:16px;height:16px;"> <img src="C:\Users\Ankita\Desktop\VESIT\WT\COUCHPOTATO\full-width-slider.slider\img\b05.png"/></div>
        </div>
        <!-- Arrow Navigator -->
...
<div style="background-color: #E4F2FF; position: absolute; width: 25%; height: 580px; left:0; top:650px;">
	<h3 align="center" class="heading"> TOP 10 MOVIES </h3>
	<table width="100%">
	<col width="40">
	<col width="40">
	<tr>
    ...
    <td><a href="#">THE GIRL ON THE TRAIN (A)</a></td>
	</tr>
	<tr>
    <td> <div class="heart-shape"></div> </td>
    <td class="percentage">77%</td>
    <td><a href="#">THE ACCOUNTANT (A)</a></td>
	</tr>
	<tr>
    <td> <div class="heart-shape"></div> </td>
    <td class="percentage">70%</td>
...
<div style="background-color: #393939; position: absolute;left:0px; top: 1280px; width: 100%; height: 105px; padding: 15px;">
...
<div style="background-color: black; position: absolute;left:0px; top: 1382px; width: 100%; height: 60px;">
