...
$res=mysqli_query($con,"SELECT * FROM mov_det WHERE mov_name='$unm'");
...
<div class="header" style=" background-image: url(black.jpg); position: absolute; top: 0px; width: 100%; height: 10%; left: 0px; padding-left: 0px; margin-left: 0px; z-index:2;">
	...
	<div style="position:absolute;top:0px;left:90%;bottom:95%;padding:0px;">
	<p style="color:white; font-size:40px;position:absolute;top:0px;z-index:15;" ><?php echo $_SESSION["fname"]; ?></p>
	</div>	
</div>	
...
<div style="position: absolute; top: 60px; left: 0px; width: 100%; height: 550px;">
	<img src="inferno2.jpg" width="100%" height="550px" />
</div>

<!-- z-index:5 -->
<div style="position: absolute; top: 330px; left: 20px; z-index: 5;">
	<img src="inferno1.jpg" width="250px" height="350px" />
</div>

<div style="position: absolute; top: 370px; left: 300px; z-index: 5;">
	<h1> Inferno </h1> <br>
</div>
<div style="position: absolute; top: 435px; left: 300px; z-index: 5; opacity:0.8;">
	<img src="UA.png" width="30px" height="30px" id="ua" />
	<p style="font-size: 15px; color: white;"> ENGLISH </p>
	<img src="calender.png" width="30px" height="30px"/>
</div>
<div style="position: absolute; top: 500px; left: 340px; z-index: 5;">
	<p style="font-size: 20px; color: white;"> 14 Oct, 2016 </p>
</div>
<div style="position: absolute; top: 558px; left: 300px; z-index: 5;">
	<img src="time.png" width="30px" height="30px"/>
</div>	
<div style="position: absolute; top: 545px; left: 340px; z-index: 5;">
	<p style="font-size: 20px; color: white;"> 2 hrs 02 mins </p>
</div>	
<!-- end of z-index:5 -->
...
<div style="position: absolute; top: 710px; left: 20px;">
	<a href="theat.php"><img src="booknow.png" width="250px" height="55px" /></a>
</div>

<!-- Summary div -->
<div style="position: absolute; top: 710px; left: 300px; height: 500px; width: 800px; border: 2px dotted gray; padding: 15px;">
	<div style=" position: absolute; width: 800px; height: 40px;">
		<img src="summary.jpg" width="110px" height="40px" /> <br>
	</div>
	<div style=" position: absolute; width: 800px; height: 40px;top: 70px;">
	<p> <b> SYNOPSIS </b> </p>
	<p> <?php echo $row['mov_summ'];?></p>
...
.jssora03r.jssora03rds{background-position:-63px -33px;opacity:.3;pointer-events:none}
	...
	<div id="jssor_1" style="position: relative; margin: 0 auto; top: 15px; left: 0px; width: 809px; height: 350px; overflow: hidden; visibility: hidden;">
<!-- Loading Screen -->
<div data-u="loading" style="position: absolute; top: 0px; left: 0px;">
<div style="filter: alpha(opacity=70); opacity: 0.7; position: absolute; display: block; top: 0px; left: 0px; width: 100%; height: 100%;"></div>
<div style="position:absolute;display:block;background:url('img/loading.gif') no-repeat center center;top:0px;left:0px;width:100%;height:100%;"></div>
</div>
<div data-u="slides" style="cursor: default; position: relative; top: 0px; left: 0px; width: 809px; height: 280px; overflow: hidden;">
<div style="display: none;">
<img data-u="image" src="tom.jpg" />
</div>
<div style="display: none;">
<img data-u="image" src="felicity.jpg" />
</div>
<div style="display: none;">
<img data-u="image" src="irrfan.jpg" />
</div>
<div style="display: none;">
<img data-u="image" src="ben.jpg" />
</div>
<div style="display: none;">
<img data-u="image" src="omar.jpg" />
</div>
</div>
<!-- Bullet Navigator -->
...
<!-- review div -->
<div style="position: absolute; top: 1290px; left: 300px; height: 500px; width: 800px; border: 2px dotted gray; padding: 15px;">
	<div style=" position: absolute; width: 800px; height: 40px;">
		<img src="review.jpg" width="110px" height="40px" /> <br>
		<p><?php echo nl2br($row['review']);?></p>
	</div>
</div>
<!-- end of reviews div -->

<div style="background-color: #393939; position: absolute;left:0px; top: 1880px; width: 1319px; height: 80px; padding: 15px;">
...
<div style="background-color: black; position: absolute;left:0px; top: 1980px; width: 100%; height: 60px;">
